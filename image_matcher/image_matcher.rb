...
class ImageMatcher
	...
	# Performs a match on the current configuration
	...
	# User ImageMagick to read in the image file
	...
	# Shrinks the are that needs to be searched.
	# We don't need to search full image. Once the
	...
	# Some ImageMagicks functions will not let you pass in a
	...
	# Determines the file name for the matchfile (see #save_match_file)
